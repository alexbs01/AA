...
# Esto para cuando tenga lo del ej05
...
function modelCrossValidation(modelType::Symbol, modelHyperparameters::Dict,
    ...
    @assert (model==:SVC) || (model==:DecissionTreeClassifier) || (model==:KNeighborsClassifier) "Model must be SVC, DecissionTreeClassifier or KNeighborsClassifier"
